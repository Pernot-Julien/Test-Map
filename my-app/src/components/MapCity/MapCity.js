        ...
        >
          ...
          {closeWindow &&
            markers.map((coordinate) => (  
              <>     
              <Marker longitude={coordinate.long} latitude={coordinate.lat} color="red" key={coordinate.id} />
               ...
               <label htmlFor="Nom">Nom</label>
                <input type="text" className='mt-[10px] w-[90%] mx-auto'/>
                <label htmlFor="Description" className='mt-[10px]'>Description</label>
                  <textarea id="Description" name="Description" className="mt-[10px] w-[90%] mx-auto">
                  </textarea>
                <select name="type" className="mt-[20px] w-[90%] mx-auto h-[25px]">
